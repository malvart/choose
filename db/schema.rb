...
ActiveRecord::Schema.define(version: 2022_05_19_081801) do
  ...
  create_table "cooking_categories", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "cooking_id"
    t.bigint "category_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["category_id"], name: "index_cooking_categories_on_category_id"
    t.index ["cooking_id"], name: "index_cooking_categories_on_cooking_id"
  end
  ...
  create_table "favorites", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["cooking_id"], name: "index_favorites_on_cooking_id"
  ...
  add_foreign_key "favorites", "cookings"
